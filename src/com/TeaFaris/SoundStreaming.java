...
public class SoundStreaming implements AutoCloseable {
    // That's not my code, I just copied that code from random site because I'm lazy guy.
	...
	*/
    ...
    public static SoundStreaming playSound(String path) {
        File f = new File(path);
        SoundStreaming snd = new SoundStreaming(f);
        snd.play();
        System.out.println("Now is streaming: " + path);
        return snd;
    }
